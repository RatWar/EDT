...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Версия = "2.3.3.45";
	Обработчик.Процедура = "ОценкаПроизводительностиСлужебный.УстановитьЗначенияКонстант_2_3_3_45";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.ОбщиеДанные = Истина;
	Обработчик.Версия = "3.0.3.202";
	Обработчик.Процедура = "ОценкаПроизводительностиСлужебный.УстановитьЗначенияКонстанты_3_0_3_202";
...
Процедура ПриЗаполненииРазрешенийНаДоступКВнешнимРесурсам(ЗапросыРазрешений) Экспорт
	...
	РаботаВМоделиСервисаСуществует = ПодсистемаСуществует("СтандартныеПодсистемы.РаботаВМоделиСервиса");
	Если РаботаВМоделиСервисаСуществует Тогда
...
Процедура УстановитьЗначенияКонстант_2_3_3_45() Экспорт
	
	Константы.КоличествоЗамеровВПакетеЭкспорта.Установить(1000);
	Константы.ПериодХраненияЗамеров.Установить(3650);
	...
	Если РегЗадание <> Неопределено Тогда
		РегЗадание.Использование = Константы.ВыполнятьЗамерыПроизводительности.Получить();
		РегЗадание.Записать();
	КонецЕсли
		
КонецПроцедуры

Процедура УстановитьЗначенияКонстанты_3_0_3_202() Экспорт
...
Процедура ЗаполнитьИмяХеш() Экспорт
	...
	Попытка
		...
		Пока Выборка.Следующий() Цикл
            ...
            СпрОбъект.ДополнительныеСвойства.Вставить(ОценкаПроизводительностиКлиентСервер.НеПроверятьПриоритет(), Истина);
