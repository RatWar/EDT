...
Процедура ПараметрыЗапросаЗначениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ТекущиеДанные.ТипКонтейнера > 0 Тогда
		...
		ОткрытьФорму("Обработка.ОИМЦ_КонсольЗапросов.Форма." + ИмяФормыРедактирования, ПараметрыОткрытия, ЭтаФорма, Ложь,
	...
	ИначеЕсли ТипЗнч(ТекущиеДанные.Контейнер) = Тип("Структура") Тогда
		...
		Если ТекущиеДанные.Контейнер.Тип = "МоментВремени" Или ТекущиеДанные.Контейнер.Тип = "Граница" Тогда
			...
			ОткрытьФорму("Обработка.ОИМЦ_КонсольЗапросов.Форма.РедактированиеГраницыМомента", ПараметрыОткрытия,
		...
		ИначеЕсли ТекущиеДанные.Контейнер.Тип = "Тип" Тогда
			...
			ОткрытьФорму("Обработка.ОИМЦ_КонсольЗапросов.Форма.РедактированиеТипа", ПараметрыОткрытия, ЭтаФорма, Истина,
				, , ОписаниеОповещенияОЗакрытииОткрываемойФормы, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
		КонецЕсли;
	...
	Иначе
		Если ТипЗнч(ТекущиеДанные.Значение) = Тип("УникальныйИдентификатор") Тогда
			...
			ОткрытьФорму("Обработка.ОИМЦ_КонсольЗапросов.Форма.РедактированиеУникальногоИдентификатора",
...
Процедура ВременныеТаблицыЗначениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОткрытьФорму("Обработка.ОИМЦ_КонсольЗапросов.Форма.РедактированиеТаблицы", ПараметрыОткрытия, ЭтаФорма, Ложь, , ,
		ОписаниеОповещенияОЗакрытииОткрываемойФормы, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
//	стрИмяФайлаОбработкиНаСервере = ПолучитьИмяФайлаОбработкиНаСервере();
	...
	ОткрытьФорму("Обработка.ОИМЦ_КонсольЗапросов.Форма.Информация", ПараметрыОткрытия, ЭтаФорма, Ложь, , , ,
		РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура Команда_РезультатВТабличныйДокумент(Команда)
	...
	ОткрытьФорму("Обработка.ОИМЦ_КонсольЗапросов.Форма.ФормаТабличногоДокумента", ПараметрыОткрытия, ЭтаФорма, Ложь);
КонецПроцедуры
...
Процедура Команда_ВставитьПредопределенноеЗначение(Команда)
	...
	ОткрытьФорму("Обработка.ОИМЦ_КонсольЗапросов.Форма.ВыборПредопределенного", ПараметрыОткрытия, ЭтаФорма, Истина, , ,
		ОписаниеОповещенияОЗакрытииОткрываемойФормы, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура Команда_СправкаАлгоритм(Команда)
	...
	ОткрытьФорму("Обработка.ОИМЦ_КонсольЗапросов.Форма.Справка", ПараметрыОткрытия, ЭтаФорма);
КонецПроцедуры
...
Процедура Команда_ПолучитьКодСПараметрами(Команда)
	...
	ОткрытьФорму("Обработка.ОИМЦ_КонсольЗапросов.Форма.ФормаКода", ПараметрыОткрытия, ЭтаФорма, Ложь, , , ,
		РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
стрСигнатураКонсоли = "ОИМЦ_КонсольЗапросов";
